...
public class parq {
    public static void main(String[] args) {
        ...
        valor= Double.parseDouble(JOptionPane.showInputDialog(" Porfavor escriba 1 si su automovil es carro  pero si no 2 si es moto "));
        ...
        JOptionPane.showMessageDialog(null, "su carro es:" + carro + "\n" +
                "su placa es:" + placa + "\n" +
